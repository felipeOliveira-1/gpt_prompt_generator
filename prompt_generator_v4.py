...
def get_user_input():
    ...
    if option == '1':
        ...
        while role_choice not in ['1', '2', '3']:
            role_choice = input(
                "Invalid role choice. Please enter a valid number or type your own role: ")
        ...
        if role_choice == '1':
            ...
            role = input(
                "Please enter the role you want GPT-3 to act as in the prompt: ")
        ...
        while style_choice not in ['1', '2', '3']:
            style_choice = input(
                "Invalid choice. Please enter a valid number or type your own style or tone: ")
        ...
        if style_choice == '1':
            ...
            style = input(
                "Please enter the style or tone you want GPT-3 to use in the prompt: ")
