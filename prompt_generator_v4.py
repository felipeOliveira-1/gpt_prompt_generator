...
def get_user_input():
    ...
    if choice == 1:
        ...
        role = roles[role_choice - 1] if role_choice != len(roles) else input("Enter the role: ")
        ...
        style = styles[style_choice - 1] if style_choice != len(styles) else input("Enter the style or tone: ")
